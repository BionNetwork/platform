...
urlpatterns = [
    ...
    url(r'^datasources/get_columnsold/$', views.GetColumnsView.as_view(), name='datasources.get_columns_old'),
    url(r'^datasources/get_columns/$', views.GetColumnsViewNew.as_view(), name='datasources.get_columns'),
