...
# datasource settings
datasource_router = routers.NestedSimpleRouter(router, r'datasources', lookup='datasource')
datasource_router.register(r'settings', views.SettingsViewSet, base_name='datasource-settings')
...
urlpatterns = [
    ...
    url(r'^', include(datasource_router.urls)),
